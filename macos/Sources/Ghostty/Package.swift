...
extension Notification.Name {
    ...
    /// Create a tab group from the current working directory and move the active tab into it.
    /// Object is the SurfaceView that triggered the action.
    static let ghosttyCreateTabGroup = Notification.Name("com.mitchellh.ghostty.createTabGroup")
}
